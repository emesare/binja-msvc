...
namespace llvm { namespace ms_demangle {
	...
	private:
		...
		NodeArrayNode* demangleFunctionParameterList(StringView& MangledName, bool& IsVariadic);
		...
		LocalStaticGuardVariableNode* demangleLocalStaticGuard(StringView& MangledName, bool IsThread);
